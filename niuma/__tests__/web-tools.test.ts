...
describe('WebSearchTool', () => {
  ...
  it('应该抛出错误当查询为空', async () => {
    await expect(webSearchTool.execute({ query: '' })).rejects.toThrow(ToolExecutionError)
  })
...
describe('WebFetchTool', () => {
  ...
  it('应该提取链接', async () => {
    const mockResponse = {
      ...
      text: async () => '<html><body><a href="https://example.com/1">Link 1</a></body></html>',
    }
  ...
  it('应该提取图片', async () => {
    const mockResponse = {
      ...
      text: async () => '<html><body><img src="image.jpg" alt="Test Image"></body></html>',
    }
