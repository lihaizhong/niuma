...
Defined in: [niuma/channels/discord/index.ts:44](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L44)
...
```ts
new DiscordChannel(config): DiscordChannel;
```

Defined in: [niuma/channels/discord/index.ts:53](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L53)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `config` | [`DiscordChannelConfig`](../interfaces/DiscordChannelConfig.md) |
...
Defined in: [niuma/channels/discord/index.ts:63](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L63)
...
Defined in: [niuma/channels/discord/index.ts:172](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L172)
...
Defined in: [niuma/channels/discord/index.ts:131](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L131)
...
Defined in: [niuma/channels/discord/index.ts:67](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L67)
...
Defined in: [niuma/channels/discord/index.ts:108](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/discord/index.ts#L108)
