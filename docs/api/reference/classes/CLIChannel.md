...
Defined in: [niuma/channels/cli/index.ts:29](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L29)
...
```ts
new CLIChannel(config?): CLIChannel;
```

Defined in: [niuma/channels/cli/index.ts:45](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L45)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `config` | [`CLIChannelConfig`](../interfaces/CLIChannelConfig.md) |
...
Defined in: [niuma/channels/cli/index.ts:54](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L54)
...
Defined in: [niuma/channels/cli/index.ts:143](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L143)
...
Defined in: [niuma/channels/cli/index.ts:128](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L128)
...
Defined in: [niuma/channels/cli/index.ts:254](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L254)
...
Defined in: [niuma/channels/cli/index.ts:246](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L246)
...
Defined in: [niuma/channels/cli/index.ts:58](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L58)
...
Defined in: [niuma/channels/cli/index.ts:105](https://github.com/lihaizhong/niuma/blob/main/niuma/channels/cli/index.ts#L105)
