# Variable: StrictNiumaConfigSchema

```ts
const StrictNiumaConfigSchema: ZodObject<{
...
Defined in: [niuma/config/schema.ts:446](https://github.com/lihaizhong/niuma/blob/main/niuma/config/schema.ts#L446)
